		...
		'fields'   => [
			...
			'heading_social_sharing_box'  => [
				...
				'fields' => [
					...
					'sharing_xing'                       => [
						'label'           => esc_html__( 'Xing', 'Avada' ),
						/* translators: Social Network name. */
						'description'     => sprintf( esc_html__( 'Turn on to display %s in the social share box.', 'Avada' ), esc_html__( 'Xing', 'Avada' ) ),
						'id'              => 'sharing_xing',
						'default'         => '1',
						'type'            => 'switch',
						'partial_refresh' => [
