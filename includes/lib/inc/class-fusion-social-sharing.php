...
class Fusion_Social_Sharing extends Fusion_Social_Icon {
	...
	public function get_sharingbox_social_links_array( $args ) {
		...
		if ( fusion_library()->get_option( 'sharing_xing' ) ) {
			$social_links_array['xing'] = [
				'url' => 'https://www.xing.com/social_plugins/share/new?sc_p=xing-share&amp;h=1&amp;url=' . rawurlencode( $args['link'] ),
			];
		}
